        ...
        if (slideIndex > 0 && slideIndex < slidesCount) {
            ...
            if (slideIndexDiff != 0) {
                switch (navigationType) {
                    ...
                    break;
                    case none:
                        WebDriverUtils.runtimeExceptionWithLogs("Cannot show slide " + slideIndex + ". There is no navigation items present.");
                }
            }
        }   else {
            WebDriverUtils.runtimeExceptionWithLogs("Cannot show slide " + slideIndex + ". Slide index is out of range.");
        }
    }
