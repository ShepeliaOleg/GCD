...
//		data.add(getMobile());
    ...
    public String getDeviceType() {
        WebDriverUtils.waitForElement(WebDriverFactory.getServerDriver(), FIELD_LAST_LOGIN_DEVICE_TYPE);
    ...
    public String getTotalBonusAmount(){
        ...
        return WebDriverUtils.getElementText(WebDriverFactory.getServerDriver(), FIELD_TOTAL_BONUS_AMOUNT_XP).substring(1);
    }

    public String getTotalBonusCurrency(){
        WebDriverUtils.waitForElement(WebDriverFactory.getServerDriver(), FIELD_TOTAL_BONUS_AMOUNT_XP);
