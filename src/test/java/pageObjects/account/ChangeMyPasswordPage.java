...
public class ChangeMyPasswordPage extends AbstractPage{
	...
	public ChangeMyPasswordPage changePassword(String oldPass, String newPass){
		return changePassword(oldPass, newPass, newPass);
	}

	public ChangeMyPasswordPage changePassword(String oldPass, String newPass, String confirmation){
