...
public class BannerTest extends AbstractTest{
    ...
    public void bannerImage() {
        ...
        validateEquals(3, slidesTypes.size(), "Count of slides");
        assertEquals(BannerSlideType.image, slidesTypes.get(0), "Slide type");
        assertTrue(bannerPage.slideIsDisplayed(1, 3), "Slide with Image is not displayed.");
    }
    ...
    public void bannerHtml() {
        ...
        assertTrue(bannerPage.slideIsDisplayed(1, 3), "Slide with HTML is not displayed.");
    }
    ...
    public void bannerWebContent() {
        ...
        assertTrue(bannerPage.slideIsDisplayed(1, 3), "Slide with WebContent is not displayed.");
    }
    ...
    public void bannerMixed() {
        ...
        List<BannerSlideType> slidesTypes = bannerPage.getSlidesTypes();
        validateEquals(7, slidesTypes.size(), "Number of slides");
        assertEquals(BannerSlideType.html, slidesTypes.get(0),      "Second slide not a HTML");
        assertEquals(BannerSlideType.webContent, slidesTypes.get(1),"Third slide not a WEBCONTENT");
        assertEquals(BannerSlideType.image, slidesTypes.get(2),     "First slide not a IMAGE");
    ...
    public void bannerNavigationNone() {
        BannerPage bannerPage = (BannerPage) NavigationUtils.navigateToPage(ConfiguredPages.bannerImage);
        assertTrue(bannerPage.slideIsDisplayed(1, 3), "First slide is not displayed.");
