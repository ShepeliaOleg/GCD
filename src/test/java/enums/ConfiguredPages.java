...
public enum ConfiguredPages{
    ...
    gamesFavouritesNoCategory("favourites_no_favourites_category"),
    gamesFavouritesCategoryFirst("favourites_category_first"),
    ...
    registerDublicateEmailLookup("register_dublicate_email"),
