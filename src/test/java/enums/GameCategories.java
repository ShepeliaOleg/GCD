...
public enum GameCategories {
    cat1No("/cat_no_subcat1", GameLaunchPage.IFRAME_GAME_1, GameLaunchPage.IFRAME_GAME_2, GameLaunchPage.REDIRECT_GAME_1, GameLaunchPage.NO_DEMO_GAME, "gtsatq", "dctw", "car", "rodz", "gts50", "gtscnb", "ro", "bjl"),
